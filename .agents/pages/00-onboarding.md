...
## UI elements
**Step 1**
- Subtitle — "Two quick questions and you're in. You'll add credentials, a project and agents next."
...
- **Info Alert** — "We'll create this folder if it doesn't exist. You can change it later in Settings → Profile" (the Workspace Folder row lives on the Profile tab)
...
- **Workspace folder** — Hosts every cloned repo and agent worktree (the database is Postgres, not in this folder); the app refuses to render the post-onboarding shell until a real path exists.
