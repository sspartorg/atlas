...
- `RelatedItemsCard` — Blocked by / Relates to / Tested by / Pull Requests sections, each hidden while empty. No "Add test link" here (`allowAddTestLink` omitted — a Task isn't a `tested_by` source).
