...
| **Bulk edit / assign on Project Detail** | `ProjectDetail.tsx` (stub toast routed from a modal trigger) | [`03-project-detail`](pages/03-project-detail.md) | "Bulk edit/assign" entry | Multi-select Tasks from the Project Detail Tasks tab and apply a batch status/assignee change | Not designed yet |
