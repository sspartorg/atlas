...
// `agent_checklists` rows; output drives the workflow engine's choice
// between following the step's pass connection, its fail connection, or
// parking the workflow run with the Owner.
//
