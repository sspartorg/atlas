...
describe('PromptPreviewDialog', () => {
    it('shows "Compiling…" when data is null', () => {
        renderWithProviders(<PromptPreviewDialog open={true} data={null} onClose={vi.fn()} />);
        expect(screen.getByText('Compiling…')).toBeTruthy();
    });

    it('shows agent name when data is provided', () => {
        renderWithProviders(<PromptPreviewDialog open={true} data={mockData} onClose={vi.fn()} />);
    ...
    it('Close button calls onClose', async () => {
        const onClose = vi.fn();
        renderWithProviders(<PromptPreviewDialog open={true} data={mockData} onClose={onClose} />);
