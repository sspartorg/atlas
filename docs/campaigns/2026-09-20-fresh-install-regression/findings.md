...
**Five rows as of 2026-09-20, all pre-filed.** The campaign has not run — these
were found by reading code while authoring
[`checklists/per-page.md`](checklists/per-page.md), and are recorded here so
the walk confirms them rather than rediscovering them.
